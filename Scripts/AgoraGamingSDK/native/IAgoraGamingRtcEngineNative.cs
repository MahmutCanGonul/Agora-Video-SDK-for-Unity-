...
namespace agora_gaming_rtc
{
    ...
    { 
        ...
        */
        ...
        protected delegate void EngineEventOnRemoteAudioStatsHandler(uint uid, int quality, int networkTransportDelay, int jitterBufferDelay, int audioLossRate, int numChannels, int receivedSampleRate, int receivedBitrate, int totalFrozenTime, int frozenRate, int totalActiveTime, int publishDuration);
...
#region DllImport
    ...
    // standard sdk api
        ...
        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int createEngine2(string appId, uint areaCode);
